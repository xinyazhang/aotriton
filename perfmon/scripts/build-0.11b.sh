...
# At this release gfx11xx is ONE group; it was split into gfx110x and
# gfx115x at 0.12b, and there is no gfx1250 asset yet.
case "${ARCH%%:*}" in
    gfx90a) IMAGES_GROUP="gfx90a" ;;
    gfx942) IMAGES_GROUP="gfx942" ;;
    gfx950) IMAGES_GROUP="gfx950" ;;
    gfx1100) IMAGES_GROUP="gfx11xx" ;;
    gfx1101) IMAGES_GROUP="gfx11xx" ;;
    gfx1150) IMAGES_GROUP="gfx11xx" ;;
    gfx1151) IMAGES_GROUP="gfx11xx" ;;
    gfx1200) IMAGES_GROUP="gfx120x" ;;
    gfx1201) IMAGES_GROUP="gfx120x" ;;
    *)
      echo "Error: AOTriton 0.11b publishes no kernel-image asset covering" >&2
      echo "       '${ARCH}'. See https://github.com/ROCm/aotriton/releases/tag/0.11b" >&2
      exit 1
      ;;
esac

ASSET="aotriton-0.11b-images-amd-${IMAGES_GROUP}.tar.gz"
IMAGES_DL_DIR="${BUILD_DIR:-${INSTALL_DIR}.build}/images-download"

TARBALL_NAME="$(fetch_release_asset "0.11b" "${ASSET}" "${IMAGES_DL_DIR}")"
